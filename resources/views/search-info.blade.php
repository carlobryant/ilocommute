                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2 flex flex-row mx-auto">
                            <div class="flex flex-col mr-1">
                                ...
                                <x-input id="pickup" class="block mt-1 w-full" type="text" name="pickup" maxlength="60" required autofocus />
                            </div>
                            <div class="flex flex-col ml-1">
                                <x-label for="destination" value="{{ __('Destination') }}" />
                                <x-input id="destination" class="block mt-1 w-full" type="text" name="destination" maxlength="60" required autofocus />
                            </div>
                        </div>
                ...
                <div class="max-w-2xl mx-auto px-4">
                    ...
                    <article class="px-6 py-3 mb-3 text-base bg-white rounded-lg border-l border-purple-600">
                        <footer class="flex justify-between items-center mb-2">
                            ...
                            @if (Auth::user() != NULL)
                                @if (Auth::user()->id === $person->user_id || Auth::user()->access === 1)
                                ...
                                onclick="delreview('{{ $review->id }}');" type="button">
                                    <svg class="h-4 w-4 text-gray-800"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="3 6 5 6 21 6" />
...
<script>
    ...
    function initializeAutocomplete(inputId) {
        var autocomplete = new google.maps.places.Autocomplete($(inputId)[0], {
            types: ['geocode']
        });
    }
</script> -->
